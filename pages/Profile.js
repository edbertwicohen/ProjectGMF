...
const Profile = () => {
    ...
    <View style={{alignItems: 'center'}}>
        <View style={{alignItems: 'center'}}>
            <Image marginTop={20} marginBottom={2} source={require('../assets/person.png')} size={150} resizeMode="contain" borderRadius={100} alt="person image"/>
            ...
            <Button marginTop={20} backgroundColor='#01579B' h='36' w='246'>LOGOUT</Button>
        </View>
    </View>
    )
}
